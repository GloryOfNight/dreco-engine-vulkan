...
material_data::material_data(const de::gltf::material& mat)
	: _baseColorFactor{de::math::vec4::narrow_construct(mat._pbrMetallicRoughness._baseColorFactor[0], mat._pbrMetallicRoughness._baseColorFactor[1], mat._pbrMetallicRoughness._baseColorFactor[2], mat._pbrMetallicRoughness._baseColorFactor[3])}
	, _emissiveFactor{de::math::vec3::narrow_construct(mat._emissive._factor[0], mat._emissive._factor[1], mat._emissive._factor[2])}
